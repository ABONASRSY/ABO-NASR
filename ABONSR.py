...
def main():
    os.system('clear')
    print("{}         ").format(r)
    print("   WELCOME TO ABO NASR SCRIPT SCANN CAM ")
    print("  WITH ABONASR")
    print("  S.Y.R")
    print("{}  BRAIN EXPERTS ").format(w)
    print("  WELCOME.. ")
    print("{}  '--------------'----------{}------------------.  ").format(r,w)
    print("{}  | {}Author  : {}ABONSR {}     | {}SY{}R{}{}IA         | ").format(r,w,r,w,r,ir,reset,w)
    print("{}  | {}Youtube : {}BRIN EXPERTS {}| {}+249129005197 {}|").format(r,w,w,w,lgray,w)
    print("{}  '------------------------------------{}-------'  ").format(r,w)
